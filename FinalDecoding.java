...
public class FinalDecoding {
    public static void main(String[] args) {
        ...
        BaseCipher[] cipherChain = {new WordReplacementCipher("neighborhood", "world"),
                new WordReplacementCipher("grill", "enigma device"),
                new WordReplacementCipher("my garage", "fort knox"),
                new WordReplacementCipher("propane-tank", "omni-matrix"),
                new WordReplacementCipher("my garage", "fort knox"),
